...
<body class="container mx-auto pt-10">
    ...
    <h1 class="text-2xl text-center">Crear Nuevo Estudiante</h1>
    <form action="/students" method="POST" class="flex flex-col w-1/4 mx-auto">
        @csrf
        ...
        <label class="my-2 w-full flex justify-between">
            Code Number:
            <input type="text" name="code_number" id="code_number" class="border border-gray-400 p-1">
        </label>
        <label class="my-2 w-full flex justify-between">
            School:
            <input type="text" name="school_id" id="school_id" class="border border-gray-400 p-1">
        </label>
