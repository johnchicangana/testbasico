...
<body class="container mx-auto pt-10">
    <h1 class="text-2xl text-center">Students Management</h1>
    <div class="flex justify-between py-4">
        <a class="rounded bg-gray-700 text-white px-7 py-3" href="/">Back to home</a>
        <a class="rounded bg-green-700 px-5 py-2 text-white" href="/students/create">Add New!</a>
    </div>
    @if ($list)
            ...
            <tbody>
                @foreach ($list as $item)
                    <tr class="text-center">
                        ...
                        <td>
                            <a href="/students/{{ $item->id }}/edit" class="rounded bg-cyan-700 px-5 py-3 text-white">Edit</a>
                        </td>
                        <td>
